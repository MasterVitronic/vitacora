...
$descripcion            = 'Donar Bitcoin,Monero,Paypal | Máster Vitronic';
...
$meta = [
    'title'             => "Hacer una Donación | Máster Vitronic",
    'descripcion'       => $descripcion,
    'author'            => $brand,
    'canonical_url'     => $url.'donate',
...
$body                   = $mustache->loadTemplate('paginas/donate/index');
